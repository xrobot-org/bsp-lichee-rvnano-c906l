...
The tests compile the C23 SGLL library and the C++20 RCC controller. Planner
...
GPIO, PWM, ADC, watchdog, I2C, SPI, and DMA adapters to SGLL. It checks GPIO
...
acknowledgments. The real LL polling implementation still runs; SGLL's own tests
